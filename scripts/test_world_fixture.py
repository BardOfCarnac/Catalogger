...
audit_source = load_json(ROOT / "data/worlds/night-city-2045/import/downtown-core.audit-v0.2.json")
...
print(
    ...
    f"Downtown stock-bearing={sum(bool(row.get('assortment')) for row in entities.values())}"
)
