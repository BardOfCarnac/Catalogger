...
assert registry_rows == 114, registry_rows
...
assert runtime_explicit_relationships == 116, runtime_explicit_relationships
assert runtime_inferred_relationships == 102, runtime_inferred_relationships
